...
const renderTeamLinks = (links) => {
 ...
 const TeamCard = ({person}) => {
    return (
        <> 
        <div className="bg-grimace lg:m-6 p-2 flex flex-wrap justify-left h-full rounded-md items-center outline-4 outline md:outline-8 outline-mTan">
            ...
            <div className="inline-flex justify-around w-full h-fit">
