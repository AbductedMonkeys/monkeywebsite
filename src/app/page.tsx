...
export default function Home() {
  ...
  return (
    <> 
      ...
      <h1 className="font-bold text-center text-3xl mt-10 md:text-8xl ">ABOUT</h1>
        <div className='w-3/4 justify-center flex flex-col lg:flex-row'>
            ...
            <div className='h-auto w-full pb-6 px-6 text-lg md:text-4xl py-10 items-center text-center'>
                <p className="py-5 px-5 items-center text-left">Abducted Monkeys is a small team of students developing our indie action game Trouble in Tornado Town. We strive to develop compact, enjoyable experiences for players of all skill levels.</p>
                <p className="py-5 px-5 items-center text-left">All of our developers are currently studying Game Design and Production at Drexel University. Trouble in Tornado Town was developed during the 3rd year of our studies and we owe a great deal of gratitude to our professors at Drexels Entrepreneurial Game Studio for their advice and industry know-how.</p>
            </div>  
        </div>
        <div className='w-3/4 justify-center items-center flex flex-col lg:flex-row-reverse'>
            <div className='h-auto w-full pb-6 px-6 text-lg md:text-3xl py-10 justify-end text-center items-center rounded-lg'>
              <Link href={"/lockjaw"}>
        ...
        <div className='w-3/4 justify-center items-center flex flex-col lg:flex-row'>
            <div className='h-auto w-full pb-6 px-6 text-lg md:text-3xl py-10 text-center items-center rounded-lg '>
