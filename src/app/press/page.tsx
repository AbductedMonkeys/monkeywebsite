        ...
        <div className="text-mPink bg-grimace justify-center pt-10 items-center flex flex-col flex-grow">
          ...
          <div className="w-full md:w-1/2 px-6 mb-6 md:mb-0 flex justify-center">
              <div className="w-full max-w-xs md:max-w-lg px-6 py-10 rounded-xl">
                ...
                <a href="https://drive.google.com/drive/folders/1XhlMzCkKwPJj6o7G-fsYHHS5hxFtRAZt?usp=sharing" target="_blank" rel="noopener noreferrer" className="block w-fit mx-auto outline outline-mPink outline-2 hover:bg-mPink hover:text-mTan font-bold text-center py-3 px-6 rounded-lg transition duration-300">Press Kit</a>
              </div>
            </div>
          <div className="w-full lg:w-3/4 my-10 justify-center flex flex-wrap">
            <a href="#" target="_blank" rel="noopener noreferrer" className="w-full md:w-1/2 lg:w-1/3 px-6  flex justify-center">
