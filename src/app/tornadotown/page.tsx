...
export default function TroubleinTornadoTown() {
  return (
    ...
    {/* */}
    <div className="text-mPink bg-grimace h-full justify-center lg:pt-32 items-center flex flex-col ">
    <div className='lg:border-mPink lg:border-b-2 w-full lg:w-3/4'>
        <h1 className="font-bold text-center text-5xl lg:text-8xl mt-20 md:mt-10">TROUBLE IN TORNADO TOWN</h1>
    </div>
    
        <div className='w-full md:w-3/4 h-auto justify-center flex flex-col xl:flex-row'>
            <div className='h-fit w-full px-6 text-lg md:text-3xl pt-5 lg:pt-20 text-center items-center'>
            ...
            <p className="2xl:py-5 px-5 text-left hidden 2xl:block">Welcome to Tornado Town, a place so lovely you&apos;ll be blown away! Trouble in Tornado town is a physics-driven cartoon destruction game where you grow into the most powerful tornado ever seen!</p>
                <p className="lg:py-5 px-5 text-left">Play as a tornado and try to destroy as much of of the landscape as possible, as quickly as possible!</p> 
            </div>
            
        </div> 
        <div className='h-auto w-full lg:w-3/4 px-6 text-lg md:text-3xl 3xl:text-5xl items-center text-center mb-10'>
        <p className="lg:py-5 px-5 text-left 2xl:hidden">Welcome to Tornado Town, a place so lovely you&apos;ll be blown away! Trouble in Tornado town is a physics-driven cartoon destruction game where you grow into the most powerful tornado ever seen!</p>
        </div>
    </div>
    </>
  );
