...
const Lockjaw = () => {
    return (
        <>
        <div className="flex items-center justify-start mx-auto h-0 lg:h-full bg-contain bg-fixed bg-center lg:bg-cover" style={{backgroundImage : `url(${lockjawHero.src})`}}> 
                <Image 
                    alt="Lockjaw Logo" 
                    src={lockjawLogoTrans} 
                    className='w-20 lg:w-1/2 py-40 pl-36'
                >  
                </Image> 
        </div>
        ...
        {/* */}
        <div className="bg-lGray text-white py-5 lg:py-20 items-center flex flex-col">
        ...
        <div className='w-full lg:w-3/4 justify-center flex flex-col xl:flex-row'>
                ...
                <div className='h-fit w-full px-6 text-lg md:text-3xl pt-5 lg:pt-10 text-center items-center'>
                    <iframe className='aspect-video w-full h-full self-center' src="https://www.youtube.com/embed/C4PINZLOrIE" title="Lockjaw: Robo-Royale - Release Date Trailer"  allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" ></iframe>
                ...
                <div className='h-auto w-full px-6 text-lg md:text-3xl 3xl:text-5xl self-center items-center text-center'>
                    <p className="pb-5 px-5 text-left">Lockjaw is a multiplayer party brawler game where robots use interchangeable arm, leg, and head parts to fight to win a Robo-Royale! </p>
            ...
            <div className='h-auto w-full lg:w-3/4 px-6 text-lg md:text-3xl 3xl:text-5xl items-center text-center'>
                    <p className="pb-5 px-5 text-left 2xl:opacity-0 2xl:h-0">Robots start each match with a blank slate—scramble for arm, leg, and head parts to amplify your capabilities and gain the upper hand. Robots can hold up to 4 parts at a time, so get greedy!</p>
                    <p className="pb-5 px-5 text-left">Adapt to the random assortment of parts in each battle. Grapple walls, dodge balls, and lock jaws! Every match is different, so be sure to change up your strategy!</p>
                    <p className="pb-5 px-5 text-left">Play Lockjaw with up to four players in local multiplayer or over Steam Remote Play Together!</p>
            </div> 
        </div>
    </>
    )
