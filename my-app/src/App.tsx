  ...
  <Navbar />
    ...
    <div id="TiTT"className="text-mPink bg-grimace rounded-lg text-2xl md:text-5xl py-16 px-4">
          ...
          <div className="">
            ...
            <p className="py-5 px-5 ">Welcome to Tornado Town, a place so lovely you'll be blown away! Trouble in Tornado town is a physics-driven cartoon destruction game where you grow into the most powerful tornado ever seen!</p>
            </div>
